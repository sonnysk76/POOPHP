...
<?php
	...
	$call = array();
	$q = "SELECT * FROM direcciones WHERE tipo='call center' LIMIT 0,5";
...
<article>
    ...
    <div id="av-texto">
		...
		for($i=0; $i<count($call); $i++){
			print "<tr><td>".utf8_encode($call[$i]->nombre)."</td></tr>";
			print "<tr><td>".utf8_encode($call[$i]->direccion)."</td></tr>";
			print "<tr><td>Tel: ".$call[$i]->telefono."</td></tr>";
			print "<tr><td>&nbsp;</td></tr>";
			print "<tr><td><img src='img/".$call[$i]->mapa."'></td></tr>";
			print "<tr><td>&nbsp;</td></tr>";
		}
		print "</table>";
		?>
