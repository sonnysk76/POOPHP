...
<section>
    <div id="ca-content">
   	  <div id="ca-mensaje">
      <p>Gracias por su compra, su registro es el <?php print $numCarrito; ?></p>
      ...
      <div id="ca-detalle">
        <table width="100%">
            ...
            <?php
				for($i=0; $i<count($r); $i++){
					...
					//
                	print '<td class="ca-cant">'.$r[$i]->cantidad.'</td>';
					//
        ...
        <table width="100%">
          ...
          <tr>
            	<th width="781" class="ca-precio">&nbsp;</th>
                <th class="ca-precio">&nbsp;</th>
                <th width="90" class="ca-cant">&nbsp;</th>
            </tr>
        </table>
      </div>      
  </div>
